...
And download the source(ofxFaceTracker) from here [here](https://github.com/kylemcdonald/ofxFaceTracker/archive/v1.1.zip), unzip the folder, rename it from ofxFaceTracker-1.1 to ofxFaceTracker and put it in your "v0.9.8_ios_release/addons" folder.
